...
INSERT INTO Skill (skillId,name, type, method_to_get_skill, description) VALUES
(1,'Прямой выпад', 'Ударный', '5', '«Прямой выпад» состоит из одного быстрого прямого удара. Благодаря тому, что навык имеет удивительно небольшую задержку после использования, можно использовать несколько выпадов в цепочке в очень короткий промежуток времени'),
(2,'Вертикальный квадрат', 'Ударный', '5', 'Комбо состоит из четырех ударов: вертикальный разрез, потом быстрая пара ударов вверх-вниз и напоследок мощный рубящий удар вверх из-за спины'),
(3,'Катана','Дополнительный','10','Открывает новый ряд навыков Катана'),
(4,'Вихрь','Ударный','5','Состоит из одного разрубающего удара в форме полукруга'),
(5,'Два клинка','Легенарный','15','Скрытый навык, открывающий владельцу новый ряд навыков "Двуручный меч"'),
(6,'Крестовидный блок','Оборонительный','10','Оборонительный навык мечника для двух клинков. Использование: скрестить два клинка так, чтобы вышел крест'),
(7,'Готовка','Базовый','5','Позволяет использовать печь'),
(8,'Обнаружение врагов','Пассивый','5','Навык увеличивающий радиус поиска. Позволяет игроку обнаруживать возможные засады и других игроков');
